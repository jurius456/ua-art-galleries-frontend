...
const HomeSearch = () => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 relative z-40 -mt-10 mb-20" ref={searchRef}>
      <div className="max-w-3xl mx-auto shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300 rounded-[32px] animate-fade-in-up delay-300 border border-zinc-200/60 bg-white dark:shadow-none dark:bg-zinc-950">
