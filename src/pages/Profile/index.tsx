...
const ProfilePage = () => {
  // 🚨 МОК-ДАНІ про користувача (пізніше замінимо на реальні дані)
  const user = {
    name: "Роман Масляна",
  ...
  const handleLogout = () => {
    ...
    // 1. Видалення токена (JWT) з локального сховища/cookie.
    // 2. Перенаправлення на сторінку Входу (/login).
    alert("Ви успішно вийшли з системи!");
    console.log("Вихід з системи...");
    // navigate('/login'); // Реальне перенаправлення
  };
